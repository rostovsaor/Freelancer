<%-- 
    Document   : registo
    Created on : Dec 10, 2019, 10:30:10 AM
    Author     : User
--%>
...
<li><a class="dropdown-item" href="#"> Softwares em destaque</a></li>
<li><a class="dropdown-item" href="#"> Softwares lancados </a></li>
...
<h2 class="page-title">Junte-se a Nos</h2>
</div>
</div>
</div>
</div>
...
Registar-se
        ...
        <form action=" <c:url value='/utilizador/add'/>" role="form" class="login-form">
            <div class="form-group">
                <div class="input-icon">
                    <i class="icon fas fa-user"></i>
                    <input type="text" class="form-control" name="entity.nome" placeholder="Usuario">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-icon">
                    ...
                    <input type="text" id="sender-email" class="form-control" name="entity.email" placeholder="Email">
                </div>
             </div>
            ...
            <div class="form-group">
                <div class="input-icon">
                    ...
                    <input type="password" class="form-control"  name="entity.senha" placeholder="Palavra_Passe">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-icon">
                    <i class="icon fas fa-unlock-alt"></i>
                    <input type="password" class="form-control" name="entity.senhaC" placeholder="Repetir a Palavra_Passe">
                </div>
            </div>
            <div class="checkbox">
                <input type="checkbox" id="remember" name="rememberme" value="forever" style="float: left;">
                <label for="remember">Ao criar a conta estaras a concordar com os termos e condicoes </label>
            </div>
        
            <button class="btn btn-common log-btn">Registar</button>
