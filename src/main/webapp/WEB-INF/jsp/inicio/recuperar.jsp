<%-- 
    Document   : recuperar
    Created on : Dec 10, 2019, 10:37:27 AM
    Author     : User
--%>
...
<title>recuperacao da senha</title>
...
<h2 class="page-title">Esqueci a Senha</h2>
</div>
</div>
</div>
</div>
...
<input type="text" id="sender-email" class="form-control" name="email" placeholder="Introduza o seu Email">
</div>
</div>
<button class="btn btn-common log-btn">Enviar</button>
</form>
<ul class="form-links">
<li class="float-left"><a href="signup.html">Registar-se</a></li>
<li class="float-right"><a href="login.html">Voltar ao login</a></li>
</ul>
</div>
</div>
</div>
