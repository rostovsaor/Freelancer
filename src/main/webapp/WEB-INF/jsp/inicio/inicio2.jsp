<%-- 
    Document   : inicio2
    Created on : Dec 10, 2019, 10:02:08 AM
    Author     : User
--%>
            ...
            <div class="col-lg-4">
                ...
                Login
                        ...
                        <div class="checkbox">
                            ...
                            <button class="btn btn-common log-btn"> Entrar</button>
                        </form>
                    <ul class="form-links">
                    <li class="float-left"><a href="${pageContext.request.contextPath}/index/registo">Registar-me</a></li>
                    <li class="float-right"><a href="#">Esqueceu a palavra-passe?</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="site-info float-left">
                <p>Direitos Reservados<a href="http://uideck.com/" rel="nofollow">  </a></p>
            </div>
