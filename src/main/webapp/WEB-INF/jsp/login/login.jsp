...
<html class="no-js" lang="en">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/img/favicon.ico">
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/sweetalert.min">
        <!-- responsive CSS
                    ============================================ -->
    ...
    <body style="background-image: url(${pageContext.request.contextPath}/resources/img/student/111.jpg); background-size: cover ">
        <!--[if lt IE 8]>
                ...
                <div class="content-error">
                    <div class="hpanel">
                        <div class="panel-body">
                            <form action="<c:url value='/entrar'/>" id="loginForm">
                                <div class="form-group">
                                    <label class="control-label" for="username">Nome do Usuario</label>
                                    <input type="text" placeholder="Ex: admin" title="Please enter you username" required="" value="" name="nome" id="username" class="form-control">
                                ...
                                <button class="btn btn-success btn-block loginbtn" onclick="    $(Mensagem){}">Entrar</button>
                                <!-- <a class="btn btn-default btn-block" href="#">Register</a> -->
                                <button class="btn btn-info btn-block loginbtn"><a href="${pageContext.request.contextPath}/utilizador/recuperarsenha">Recuperar Senha</a></button>
